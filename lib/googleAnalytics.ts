...
export async function getAnalyticsData(
  ...
  const [
    ...
    getEventCount(client, startDate, endDate, "phone_copy"),
  ...
  if (includeTrends) {
    const [
      ...
      getEventCount(client, prevStartDate, prevEndDate, "phone_copy"),
    ...
    trends = {
      ...
      phoneCopies: calculateTrend(phoneCopies, prevPhoneCopies),
  ...
  const blocks: object[] = [
    ...
    },
    {
      ...
      fields: [
        ...
        {
          type: "mrkdwn",
          text: `*💬 Text Us (Copy)*\n${data.phoneCopies}${formatTrend(data.trends?.phoneCopies)}`,
        },
      ],
    },
    {
