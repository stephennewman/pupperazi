...
export default function WashNGoBaths() {
  ...
  const structuredData = {
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Wash N Go Bath Services",
      "itemListElement": [
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "Wash N Go Bath - Under 25lbs",
            "description": "Quick bath with sudsy wash, ear cleaning, and towel dry"
          },
          "price": "15",
          "priceCurrency": "USD"
        },
        ...
        },
        {
          ...
          "itemOffered": {
            "@type": "Service",
            "name": "Wash N Go Bath - Over 100lbs",
            "description": "Quick bath with sudsy wash, ear cleaning, and towel dry"
          },
          "price": "25",
          "priceCurrency": "USD"
        ...
        <section className="pt-8 pb-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 font-light">
              Quick, convenient, and affordable pet bathing
            </p>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center mb-12">
                <p className="text-xl text-gray-700 mb-8 leading-relaxed">
                  Wanna save time and/or money? Our convenient "quick" baths are perfect for just getting them clean without destroying your bathroom. They include a sudsy bath, ear cleaning, and a towel dry so they will still be a little damp afterwards.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-100 to-blue-100 p-8 rounded-2xl shadow-lg mb-12">
                <h2 className="text-3xl font-bold text-purple-900 mb-8 text-center">
                  🚿 Wash N Go Bath Pricing
                </h2>
                
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="bg-white p-6 rounded-xl shadow-md text-center">
                    <h3 className="text-lg font-semibold text-purple-900 mb-2">Under 25lbs</h3>
                    <p className="text-3xl font-bold text-purple-600">$15</p>
                  </div>
                  
                  <div className="bg-white p-6 rounded-xl shadow-md text-center">
                    <h3 className="text-lg font-semibold text-purple-900 mb-2">26-50lbs</h3>
                    <p className="text-3xl font-bold text-purple-600">$17</p>
                  </div>
                  
                  <div className="bg-white p-6 rounded-xl shadow-md text-center">
                    <h3 className="text-lg font-semibold text-purple-900 mb-2">51-75lbs</h3>
                    <p className="text-3xl font-bold text-purple-600">$20</p>
                  </div>
                  
                  <div className="bg-white p-6 rounded-xl shadow-md text-center">
                    <h3 className="text-lg font-semibold text-purple-900 mb-2">76-100lbs</h3>
                    <p className="text-3xl font-bold text-purple-600">$20</p>
                  </div>
                  
                  <div className="bg-white p-6 rounded-xl shadow-md text-center">
                    <h3 className="text-lg font-semibold text-purple-900 mb-2">Over 100lbs</h3>
              ...
              <div className="bg-gradient-to-br from-blue-100 to-purple-100 p-8 rounded-2xl shadow-lg">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="bg-white p-6 rounded-xl shadow-md text-center">
                    <h3 className="text-lg font-semibold text-purple-900 mb-2">Nail trim</h3>
                    <p className="text-2xl font-bold text-purple-600">$10</p>
                  </div>
                  
                  <div className="bg-white p-6 rounded-xl shadow-md text-center">
                    <h3 className="text-lg font-semibold text-purple-900 mb-2">Nail trim & Dremel</h3>
                    <p className="text-2xl font-bold text-purple-600">$18</p>
                  </div>
                  
                  <div className="bg-white p-6 rounded-xl shadow-md text-center">
                    <h3 className="text-lg font-semibold text-purple-900 mb-2">Anal glands add on</h3>
                    <p className="text-2xl font-bold text-purple-600">$5</p>
                    <p className="text-sm text-gray-600 mt-1">($10 without bath)</p>
                  </div>
                  
                  <div className="bg-white p-6 rounded-xl shadow-md text-center">
                    <h3 className="text-lg font-semibold text-purple-900 mb-2">Teeth</h3>
                    <p className="text-2xl font-bold text-purple-600">$5</p>
                  </div>
                  
                  <div className="bg-white p-6 rounded-xl shadow-md text-center">
                    <h3 className="text-lg font-semibold text-purple-900 mb-2">Brushout</h3>
                    <p className="text-2xl font-bold text-purple-600">$10/5 minutes</p>
                  </div>
                  
                  <div className="bg-white p-6 rounded-xl shadow-md text-center">
                    <h3 className="text-lg font-semibold text-purple-900 mb-2">Blow dry</h3>
                    <p className="text-2xl font-bold text-purple-600">$10/5 minutes</p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 bg-gradient-to-br from-purple-50 to-blue-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="text-white p-12 rounded-2xl" style={{backgroundColor: '#3D6B9F'}}>
              <h2 className="text-3xl font-bold mb-6">Ready for a Quick Clean?</h2>
